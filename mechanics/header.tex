\documentclass[ngerman, DIV=11, BCOR=0mm, paper=a4, fontsize=12pt, parskip=half, twoside=false, titlepage=true]{scrreprt}
...
\setkomafont{chapter}{\rmfamily\Huge\bfseries}%{\fontfamily{qpl}\selectfont\Huge}
\setkomafont{chapterentry}{\rmfamily\large\bfseries}%{\fontfamily{qpl}\selectfont\large\bfseries}
\setkomafont{section}{\rmfamily\Large\bfseries}%{\fontfamily{qpl}\selectfont\Large}
...
\setkomafont{subsection}{\rmfamily\large}%{\fontfamily{qpl}\selectfont\large}
\setkomafont{title}{\Huge\bfseries}{\fontfamily{qpl}\selectfont\Huge\bfseries}
\setkomafont{subtitle}{\LARGE\scshape}%{\fontfamily{qpl}\selectfont\LARGE\scshape}
...
\newcommand{\anm}[1]{\fcolorbox{yellow!24}{yellow!24}{\parbox[c]{0.985\textwidth}{\textbf{Anmerkung}: #1}}}
