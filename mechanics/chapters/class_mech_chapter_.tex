...
As we have learned, EM fields carry a momentum along with energy. For EM fields, this momentum is called \Def{radiation pressure}. Assuming $\vec{k}$ is perpendicular to its surface $A$, the momentum exerted on a body over a time period $\Delta t$ is
\begin{equation}
