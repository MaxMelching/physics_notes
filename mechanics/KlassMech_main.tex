...
%\vspace{1cm}
%\includegraphics[width=0.6\textwidth]{Bilder/Titelbild_KlassMech_V4.pdf}

\vspace{-4\baselineskip}
\includegraphics[width=0.9\textwidth]{Bilder/Titelbild_KlassMech_V5.pdf}
\vspace{-\baselineskip}
}
...
\subfile{chapters/KlassMech_chapter1}

\subfile{chapters/KlassMech_chapter2}

\subfile{chapters/KlassMech_chapter3}

\subfile{chapters/KlassMech_chapter4}

\subfile{chapters/KlassMech_chapter5}
