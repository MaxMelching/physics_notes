...
\end{equation}
with the \Def{electromagnetic field tensor} $\mathbf{F}$. As we can see from the number of indices, it is a 2-tensor. In the Lorentz-force, it appears through its contravariant components
