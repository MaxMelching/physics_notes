...
-> introduce $\mathcal{L}, \mathcal{L}'$ as ruler labels (?)
...
-> \todo{NO! This is just effect of one of the plots! where both of them move with same velocity relative to the rest frame}
...
\begin{figure}
	...
	\caption{Length contraction via synchronized observers in a spacetime diagram.}
