...
\begin{figure}
	...
	\subfloat[Observers at rest relative to each other in their rest frame]{
		\input{pictures/synchronization_resting_observers_a.tex}
	%\hspace*{0.05\textwidth}
	}\hspace*{0.2\textwidth}
	%
	\subfloat[Observers at rest relative to each other in frame moving relative to them]{
	%\hspace*{0.05\textwidth}
		\input{pictures/synchronization_resting_observers_b.tex}
	...
	\begin{minipage}{0.5\textwidth}
		...
		%\hspace*{0.05\textwidth}
			\input{pictures/synchronization_resting_observers_c.tex}
		}
	\end{minipage}%\hfill
	\begin{minipage}{0.5\textwidth}
...
\begin{figure}
	...
	\subfloat[Observers moving with relative velocity $v = 0.6 c$]{
		\input{pictures/synchronization_moving_observers_a.tex}
	}
	%
	%\hspace*{0.2\textwidth}
	\hspace*{0.05\textwidth}
	...
	%\hspace*{0.05\textwidth}
		\input{pictures/synchronization_moving_observers_b.tex}
	}
	%
	\hspace*{0.05\textwidth}
	%
	...
	\todo{if referee desynchronizes, then note that $t_-, t'_-$ are chosen such that they meet in the middle between the two observers}
	}
	\label{fig:moving_clocks}
\end{figure}

% \footnotetext{Beware that the diagrams are not perfect, e.g.~the referee should be exactly where the light beams cross again. This is most likely due to an error in my code, which I was unable to locate. Nonetheless, the most important ideas should still be conveyed (for an analogous graphic, see Fig.~2.8 of \cite{dragon_geometry_srt}).\todo{is this comment still recent?}}
