...
\begin{tikzpicture}
    ...
    \node[above left=-2, labelledpoint] at (ABhalfl) {\contour{white}{$t$}};
    \node[above right, labelledpoint] at (CDhalfr) {\contour{white}{$t' = t$}};

    \node[below left] at (El) {\contour{white}{$\tau$}};
    \node[below right=-2] at (Fr) {\contour{white}{$\tau' = \tau$}};
