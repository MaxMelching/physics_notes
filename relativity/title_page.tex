...
\begin{tikzpicture}
	\draw[black!50!green, smooth, thick, shift={(\xshiftGW,0)}, xscale=10.0, yscale=1.2] plot file {code/exported_template_2.txt}; % xscale, yscale were found empirically; important: xscale AFTER shift
	% Pad signal to left
